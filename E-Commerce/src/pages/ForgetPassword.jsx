...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Govind Hub - Forgot Password</title>
        <meta
          name="description"
          content="Reset your password for your Govind Hub account. Follow the instructions to recover your access."
        />
        <meta
          name="keywords"
          content="Govind Hub, forgot password, password recovery, reset password"
        />
      </Helmet>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:gap-6">
          ...
          {error && (
            <p className="text-center text-red-600">
              Error in sending mail, try later
            </p>
          )}
