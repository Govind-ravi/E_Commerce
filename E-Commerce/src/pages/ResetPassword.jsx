...
const ResetPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Govind Hub - Reset Password</title>
        <meta
          name="description"
          content="Set a new password for your Govind Hub account. Follow the instructions to securely update your password."
        />
        <meta
          name="keywords"
          content="Govind Hub, reset password, update password, account security"
        />
      </Helmet>
      ...
      <div className="bg-[#cc80f9] w-[90%] sm:w-[30%] p-6 px-12 mx-auto mt-10 rounded-lg shadow-lg font-semibold">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="rounded-lg py-2 px-4 mx-auto bg-gray-800 text-white"
          >
            Reset Password
          </button>
        </form>
