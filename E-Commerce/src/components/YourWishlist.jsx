...
const YourWishlist = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Govind Hub - {`${user?.name}`}'s Wishlist</title>
        <meta
          name="description"
          content="View and manage your wishlist on Govind Hub. Save your favorite products and keep track of items you want to purchase later."
        />
        <meta
          name="keywords"
          content="Govind Hub, your wishlist, wishlist management, favorite products, save items"
        />
      </Helmet>
